...
NUM_THREADS_ARRAY = [150]#, 20, 50, 100, 150, 200]#[10, 20, 30, 40, 50, 100, 150, 200]#, 250]#, 300]#, 400, 500, 600, 700, 800, 900, 1000]
...
if __name__ == "__main__": 
    ...
    f = open("HFU_LV_WITHPAL_RESULTS/total_response_time_noPAL_noHPA(5replicas)(2).data","a+")
    ...
    f.write("WORKLOAD: LV_HF; PAL CONFIG: cache_and_compression; NUMBER OF REPLICAS: 5 \n")
