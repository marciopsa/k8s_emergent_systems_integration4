...
URL = "http://34.67.191.1:2020/collector/datafromresource/1"
...
def updating_data_collector():  
    while flag == 1: 
        ...
        try:
            url = "http://34.67.191.1:2020/collector/data/1"
...
#def make_request():
    ...
    resp = req.get("http://34.67.191.1:2020/collector/datafromresource/1")
...
if __name__ == "__main__": 
    ...
    f = open("HFU_LV_WITHPAL_RESULTS/Response_time_withPAL_noHPA(0).data","a+")
    ...
    f.write("WORKLOAD: HFU_LV \n")  #; PAL CONFIG: default; NUMBER OF REPLICAS: 1 \n")
