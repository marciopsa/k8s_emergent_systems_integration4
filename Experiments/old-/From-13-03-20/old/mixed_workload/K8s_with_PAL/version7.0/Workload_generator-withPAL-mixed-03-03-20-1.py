...
NUM_THREADS_ARRAY = [1,2,4,8,16,32,33,34,35,36,37,38,39,40]#64,65,66,67,68,69,70]#,71,72,73,74,75,76,77,78,79,80]#, 20, 50, 100, 150, 200]#
...
"""if __name__ == "__main__": 
    ...
    # After the end of the execution, the data will be stored in a file.
    f = open("LFU_HV_WITHPAL_RESULTS/Response_time_withPAL(0).data","a+")
