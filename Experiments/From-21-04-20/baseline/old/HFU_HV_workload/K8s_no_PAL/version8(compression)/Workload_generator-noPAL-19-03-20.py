...
HFU_HV_REQUEST_URL = "http://35.224.101.35:2020//collector/resources/1/data"
...
if __name__ == "__main__": 
    ...
    f = open("HFU_HV_NOPAL_RESULTS/Response_time_noPAL(0).data","a+")
    ...
    f.write("DATA COLLECTOR SETTING: COMPRESSION;  \n")
